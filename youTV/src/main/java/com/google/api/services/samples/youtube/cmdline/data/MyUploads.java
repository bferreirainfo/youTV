...
public class MyUploads {
    ...
    /**
     * Authorize the user, call the youtube.channels.list method to retrieve the playlist ID for
     * the list of videos uploaded to the user's channel, and then call the
     * youtube.playlistItems.list method to retrieve the list of videos in that playlist.
     * 
    ...
    public static List<PlaylistItem> myUploads() {
