...
/**
 * Upload a video to the authenticated user's channel. Use OAuth 2.0 to authorize the request. Note
 * that you must add your video files to the project folder to upload them with this application.
 * 
...
public class UploadVideo {
    ...
    /**
     * Upload the user-selected video to the user's YouTube channel. The code looks for the video
     * in the application's project folder and uses OAuth 2.0 to authorize the API request.
     * 
    ...
    public static void upload(UploadedFile file) {
        ...
        try {
            ...
            System.out.println("Uploading: " + file == null ? SAMPLE_VIDEO_FILENAME : file
                    .getFileName());
            ...
            snippet.setTitle("Test Upload via Java on " + cal.getTime() + "FIle name: " + file == null ? SAMPLE_VIDEO_FILENAME
                    : file.getFileName());
            ...
            InputStreamContent mediaContent =
                    new InputStreamContent(VIDEO_FILE_FORMAT,
                            file == null ? UploadVideo.class
                                    .getResourceAsStream("/sample-video.mp4") : file
                                    .getInputstream());
