...
public class InvideoProgramming {
    ...
    /**
     * This code sample demonstrates different ways that the API can be used to promote your
     * channel content. It includes code for the following tasks:
     * <ol>
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ChannelListResponse channelListResponse =
                    youtube.channels().list("id,contentDetails").setMine(true)
            ...
            Channel updateChannelResponse =
                    youtube.channels().update("invideoPromotion", channel).execute();
            ...
            System.out.println("\t- Invideo promotion video ID: "
                    + promotedItem.getId().getVideoId());
            ...
            System.out
                    .println("\t- Invideo promotion URL: " + promotedItem.getId().getWebsiteUrl());
            System.out.println("\t- Promotion message: " + promotedItem.getCustomMessage());
